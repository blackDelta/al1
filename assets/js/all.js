/*1349094300,172633389,JIT Construction: v636851,en_US*/
...
try {
    window.FB || (function (window) {
        ...
        __d("sdk.Model", ["Assert", "Type", "ObservableMixin"], function (a, b, c, d, e, f) {
            var g = b('Assert'), h = b('Type'), i = b('ObservableMixin'), j = h.extend({constructor:function (k) {
                g.isObject(k);
                this.parent();
                var l = {}, m = this;
        ...
        __d("sdk.Runtime", ["sdk.Model", "copyProperties"], function (a, b, c, d, e, f) {
            var g = b('sdk.Model'), h = b('copyProperties'), i = {UNKNOWN:0, PAGETAB:1, CANVAS:2, PLATFORM:4}, j = new g({AccessToken:'', UserID:0, ClientID:'', Initialized:false, LoginStatus:undefined, Environment:i.UNKNOWN, Secure:undefined, UseCookie:false});
        ...
        __d("FB", ["copyProperties", "dotAccess", "sdk.ErrorHandling", "sdk.getContextType", "GlobalCallback", "guid", "sdk.Insights", "Log", "sdk.Runtime", "safeEval", "sdk.Scribe", "wrapFunction", "SDKConfig"], function (a, b, c, d, e, f) {
            var g = b('copyProperties'), h = b('dotAccess'), i = b('sdk.ErrorHandling'), j = b('sdk.getContextType'), k = b('GlobalCallback'), l = b('guid'), m = b('sdk.Insights'), n = b('Log'), o = b('sdk.Runtime'), p = b('safeEval'), q = b('sdk.Scribe'), r = c('SDKConfig'), s = b('wrapFunction'), t, u, v, w = h(r, 'api.mode'), x = {};
            t = FB;
            u = window.FB = {};
                        ...
                        return i.guard(function () {
                            if (ha === 'warn') {
                                ...
                                if (!x.hasOwnProperty(ea)) {
                                    ...
                                    q.log('jssdk_error', {appId:t._apiKey, error:'Private method used', extra:{args:ea}});
                                    x[ea] = true;
                                }
                            }
            ...
            function z(da, ea) {
                var fa = da ? h(t, da, true) : t, ga = da ? h(u, da, true) : u;
                ES5(ES5('Object', 'keys', false, ea), 'forEach', true, function (ha) {
                    var ia = ea[ha];
                    fa[ha] = ia;
                    if (typeof ia === 'function') {
                        var ja = (da ? da + '.' : '') + ha, ka = y(ia, ja, ha, fa);
                        if (ka)ga[ha] = ka;
                    }
                });
            }

            var aa = /iframe_canvas|app_runner/.test(window.name), ba = /dialog/.test(window.name);
            ...
            g(t, {_apiKey:null, _authResponse:null, _logging:true, _inCanvas:aa, onlyUseHttps:function () {
                return o.getSecure() === true;
            }, onlyUseHttp:function () {
                return o.setSecure() === false && location.protocol == 'http:';
            }, _locale:null, _localeIsRtl:false, getDomain:function (da, ea) {
            ...
            }, dotAccess:h, Runtime:o, guard:i.guard, unguard:i.unguard, wrapFunction:s, safeEval:p, _getContextType:j});
            if (u)g(u, {provide:function () {
                n.error('FB.provide is no longer supported');
                if (!x.hasOwnProperty('provide')) {
                    m.log(m.TYPE.ERROR, m.CATEGORY.DEPRECATED, 'FB.provide');
                    q.log('jssdk_error', {appId:t._apiKey, error:'Private method used', extra:{args:'provide'}});
                    x.provide = true;
                }
            }});
            e.exports = t;
        ...
        __d("sdk.Auth", ["sdk.Cookie", "copyProperties", "sdk.createIframe", "DOMWrapper", "sdk.getContextType", "guid", "ObservableMixin", "QueryString", "sdk.Runtime", "sdk.SignedRequest", "UrlMap", "URL", "sdk.XD"], function (a, b, c, d, e, f) {
            ...
            function w(aa, ba) {
                ...
                var fa = !ca && aa, ga = ca && !aa, ha = aa && ca && ca != da, ia = aa != t, ja = ba != (o.getLoginStatus() || 'unknown');
                o.setLoginStatus(ba);
        ...
        __d("sdk.DOM", ["Assert", "createArrayFrom", "DOMEventListener", "sdk.domReady", "UserAgent"], function (a, b, c, d, e, f) {
            var g = b('Assert'), h = b('createArrayFrom'), i = b('DOMEventListener'), j = b('sdk.domReady'), k = b('UserAgent'), l = {};
            ...
            function p(w, x, y) {
                ...
                var z = x.getElementsByTagName(y), aa = [];
            ...
            function q(w, x) {
                ...
                var y = w.currentStyle || document.defaultView.getComputedStyle(w, null), z = y[x];
            ...
            function t() {
                ...
                return {scrollTop:w.scrollTop || document.body.scrollTop, scrollLeft:w.scrollLeft || document.body.scrollLeft, width:window.innerWidth ? window.innerWidth : w.clientWidth, height:window.innerHeight ? window.innerHeight : w.clientHeight};
            }
            ...
            var v = {containsCss:m, addCss:n, removeCss:o, getByClass:p, getStyle:q, setStyle:r, addCssRules:s, getViewportInfo:t, getPosition:u, ready:j};
            e.exports = v;
        });
        __d("legacy:fb.dom", ["FB", "sdk.DOM"], function (a, b, c, d) {
            var e = b('FB'), f = b('sdk.DOM');
            e.provide('Dom', f);
        }, 3);
        ...
        __d("legacy:fb.auth", ["sdk.Auth", "copyProperties", "sdk.Event", "FB", "Log", "sdk.Runtime", "sdk.ui", "SDKConfig"], function (a, b, c, d) {
            var e = b('sdk.Auth'), f = b('copyProperties'), g = b('sdk.Event'), h = b('FB'), i = b('Log'), j = b('sdk.Runtime'), k = c('SDKConfig'), l = b('sdk.ui'), m;
            h.provide('', {getLoginStatus:function (n, o) {
                if (!j.getClientID()) {
                    i.warn('FB.getLoginStatus() called before calling FB.init().');
                    return;
                }
                if (n)if (!o && m == 'loaded') {
                    n({status:j.getLoginStatus(), authResponse:h.getAuthResponse()});
                    return;
                ...
                l(f({method:'permissions.oauth', display:j.isEnvironment(j.ENVIRONMENTS.CANVAS) && k.useAsync ? 'async' : 'popup', domain:location.hostname}, o || {}), n);
            }, logout:function (n) {
                l({method:'auth.logout', display:'hidden'}, n);
            }});
            h.provide('Auth', e);
        ...
        __d("XFBML", ["Assert", "FB", "Log", "ObservableMixin", "copyProperties", "createArrayFrom", "dotAccess", "runOnce"], function (a, b, c, d, e, f) {
            var g = b('Assert'), h = b('FB'), i = b('Log'), j = b('ObservableMixin'), k = b('copyProperties'), l = b('createArrayFrom'), m = b('dotAccess'), n = b('runOnce'), o = {}, p = {}, q = 0, r = new j();
            ...
            function x(y, z, aa) {
                ...
                ES5(l(y.getElementsByTagName('*')), 'forEach', true, function (ga) {
                    ...
                    ca++;
                    da++;
                    var ia = ha.ctor || m(h, ha.className.substr(3)), ja = new ia(ga, ha.xmlns, ha.localName, w(ga));
        ...
        __d("IframePlugin", ["sdk.DOM", "sdk.Event", "FB", "ObservableMixin", "PluginTags", "QueryString", "sdk.Runtime", "Type", "UrlMap", "sdk.XD", "XFBML", "guid", "insertIframe", "resolveURI"], function (a, b, c, d, e, f) {
            var g = b('sdk.DOM'), h = b('sdk.Event'), i = b('FB'), j = b('ObservableMixin'), k = b('PluginTags'), l = b('QueryString'), m = b('sdk.Runtime'), n = b('Type'), o = b('UrlMap'), p = b('sdk.XD'), q = b('XFBML'), r = b('guid'), s = b('insertIframe'), t = b('resolveURI'), u = {skin:'string', font:'string', width:'px', height:'px', ref:'string', color_scheme:'string'};
            ...
            function v(ba, ca) {
                return function (da) {
                    ...
                    var fa = ba.getElementsByTagName('span')[0], ga = ba.getElementsByTagName('iframe')[0], ha = ga.style.height === fa.style.height && ga.style.width === fa.style.width, ia = ha ? 'removeCss' : 'addCss';
            ...
            function w(ba) {
                return function (ca) {
                    var da = {width:ca.width, height:ca.height, pluginID:ba};
                    h.fire('xfbml.resize', da);
                };
            }

            var x = {string:function (ba) {
                return ba;
            }, bool:function (ba) {
            ...
            var aa = n.extend({constructor:function (ba, ca, da, ea) {
                this.parent();
                da = da.replace(/-/g, '_');
                ...
                var fa = o.resolve('www') + '/plugins/' + da + '.php?', ga = {};
                z(k[da], ba, ea, ga);
                z(u, ba, ea, ga);
                ...
                this.subscribe('xd.verify', function (ka) {
                    p.sendToFacebook(ia, {method:'xd/verify', params:ES5('JSON', 'stringify', false, ka.token)});
                });
                var ja = document.createElement('span');
                ja.style.width = '0px';
                ja.style.height = '0px';
                this._element = ba;
                this._config = {root:ja, url:fa + l.encode(ga), name:ia, width:ga.width || 1000, height:ga.height || 1000, onload:ES5(this.inform, 'bind', true, this, 'render')};
            }, process:function () {
            ...
            ES5(ES5('Object', 'keys', false, k), 'forEach', true, function (ba) {
                q.registerTag({xmlns:'fb', localName:ba.replace(/_/g, '-'), ctor:aa});
            });
            e.exports = aa;
        });
        ...
        __d("RegisterTags", ["PluginCustomClass", "XFBML"], function (a, b, c, d, e, f) {
            var g = b('PluginCustomClass'), h = b('XFBML');
            ...
            ES5(g, 'forEach', true, function (j) {
                h.registerTag({xmlns:'fb', localName:j, className:'FB.XFBML.' + ES5(j.split('-'), 'map', true, i).join('')});
            });
        });
        __d("legacy:fb.xfbml", ["FB", "XFBML", "IframePlugin", "RegisterTags"], function (a, b, c, d) {
            var e = b('FB'), f = b('XFBML');
            b('IframePlugin');
            b('RegisterTags');
            e.provide('XFBML', {getBoolAttr:function (g, h) {
            ...
            }, parse:f.parse, registerTag:f.registerTag});
        ...
        __d("legacy:fb.init", ["sdk.Auth", "sdk.Canvas", "sdk.Canvas.Prefetcher", "sdk.Cookie", "copyProperties", "DOMWrapper", "sdk.domReady", "sdk.Event", "FB", "sdk.Frictionless", "Log", "sdk.Runtime", "sdk.SignedRequest", "UserAgent", "sdk.XD"], function (a, b, c, d) {
            var e = b('sdk.Auth'), f = b('sdk.Canvas'), g = b('sdk.Canvas.Prefetcher'), h = b('sdk.Cookie'), i = b('copyProperties'), j = b('DOMWrapper'), k = b('sdk.domReady'), l = b('sdk.Event'), m = b('FB'), n = b('sdk.Frictionless'), o = b('Log'), p = b('sdk.Runtime'), q = b('sdk.SignedRequest'), r = b('UserAgent'), s = b('sdk.XD'), t = document.createElement('div');
            j.setRoot(t);
            k(function () {
                o.info('domReady');
            ...
            o.level = 1;
            m.provide('', {initSitevars:{}, init:function (u) {
                ...
                u = i({logging:true, status:true}, u || {});
        ...
        __d("legacy:fb.pay", ["FB", "sdk.XD", "sdk.Runtime"], function (a, b, c, d) {
            var e = b('FB'), f = b('sdk.XD'), g = b('sdk.Runtime'), h = {error_code:1383001, error_message:'An unknown error caused the dialog to be closed'}, i = function (j) {
                return function (k) {
                    j(k && k.response ? ES5('JSON', 'parse', false, k.response) : h);
                };
            };
            e.provide('UIServer.Methods', {'pay.prompt':{transform:function (j) {
                var k = f.handler(i(j.cb), 'parent.frames[' + (window.name || 'iframe_canvas') + ']');
                j.params.channel = k;
                f.inform('Pay.Prompt', j.params);
                return false;
            }}});
            e.provide('UIServer.Methods', {pay:{size:{width:555, height:120}, noHttps:true, connectDisplay:'popup', transform:function (j) {
                j.cb = i(j.cb);
        ...
        FB.subclass('XFBML.Like', 'XFBML.EdgeWidget', null, {getUrlBits:function () {
